...
class EventoRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            //
            'cod_evento'=>'required|max:5|unique:evento,cod_evento',
            'nombre'=>'required',
    ...
    public function messages(){
        return[
            ...
            'cod_evento.max'=>'El largo del código sale de los parametros esperados',
            'cod_evento.unique'=>'El código del evento debe ser único',
            'nombre.required'=>'El nombre del evento es obligatorio',
            'fecha_evento.required'=>'La fecha del evento es obligatoria',
            'fecha_evento.date'=>'El formato de la fecha no es valido, ingreselo nuevamente',
